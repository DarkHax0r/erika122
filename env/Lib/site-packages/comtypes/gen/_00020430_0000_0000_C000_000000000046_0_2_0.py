...
__all__ = [
    'FONTSIZE', 'Default', 'Unchecked', 'FONTNAME',
    'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_CONTAINER', 'Picture', 'Color',
    'OLE_YPOS_HIMETRIC', 'Font', 'IPicture', 'IFont', 'FontEvents',
    'OLE_XPOS_PIXELS', 'FONTUNDERSCORE', 'OLE_XPOS_CONTAINER',
    'FONTSTRIKETHROUGH', 'FONTITALIC', 'OLE_YSIZE_HIMETRIC',
    'OLE_OPTEXCLUSIVE', 'VgaColor', 'OLE_TRISTATE',
    'OLE_XPOS_HIMETRIC', 'OLE_COLOR', 'StdFont', 'OLE_YPOS_PIXELS',
    'Checked', 'OLE_YSIZE_PIXELS', 'OLE_HANDLE', 'Monochrome',
    'OLE_YPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL', 'Gray',
    'LoadPictureConstants', 'IFontDisp', 'OLE_CANCELBOOL', 'FONTBOLD',
    'OLE_XSIZE_PIXELS', 'IFontEventsDisp', 'OLE_XSIZE_CONTAINER',
    'IPictureDisp', 'StdPicture'
]

_check_version('1.2.0', 1651900738.765207)
