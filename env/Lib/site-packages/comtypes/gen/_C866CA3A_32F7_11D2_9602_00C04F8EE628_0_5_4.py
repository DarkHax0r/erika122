...
__all__ = [
    'DISPID_SRAudioInputStream', 'SRSActive', 'SREStateChange',
    'DISPID_SDKDeleteKey', 'DISPID_SRRDiscardResultInfo',
    'ISpeechPhraseRules', 'DISPID_SPIRule', 'SRSInactive',
    'SPRS_ACTIVE', 'ISpRecoGrammar2', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SDKSetLongValue', 'SVSFParseSsml', 'DISPID_SVSLastResult',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SOTsCount', 'SP_VISEME_0',
    'DISPID_SVSCurrentStreamNumber', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechDataKey', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'WAVEFORMATEX', 'SVP_14', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechAudioBufferInfo', 'eLEXTYPE_PRIVATE19',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCResume',
    'ISpeechGrammarRules', 'SAFT24kHz16BitMono',
    'DISPID_SpeechFileStream', 'DISPID_SRRTLength',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_10',
    'DISPID_SpeechBaseStream', 'SPDKL_CurrentUser', 'SAFTText',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRRAudioFormat',
    'DISPID_SVAudioOutput', 'SRAORetainAudio', 'DISPID_SpeechAudio',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPPBRestorePhraseFromMemory', 'STCAll',
    'ISpeechXMLRecoResult', 'SpeechPropertyHighConfidenceThreshold',
    'eLEXTYPE_PRIVATE11', 'SVEPhoneme', 'DISPID_SPIAudioSizeTime',
    'SpeechPropertyLowConfidenceThreshold', 'SPDKL_CurrentConfig',
    'DISPID_SGRName', 'DISPID_SDKEnumValues', 'SASPause',
    'DISPID_SPPNumberOfElements', '_ISpeechRecoContextEvents',
    'DISPID_SPRFirstElement', 'SPEI_RESERVED5', 'SPSERIALIZEDRESULT',
    'SPEI_SR_BOOKMARK', 'SAFT24kHz8BitStereo', 'SPSHT_OTHER',
    'DISPID_SPACommit', 'SAFTADPCM_8kHzStereo', 'SPBO_PAUSE',
    'SpeechRunState', 'DISPID_SPPParent', 'SECFIgnoreCase',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechLexiconWord',
    'SpResourceManager', 'SPEI_MIN_SR', 'SpMMAudioEnum',
    'DISPID_SpeechLexiconWords', 'SAFT12kHz16BitMono',
    'DISPID_SOTCSetId', 'SPSLMA', 'ISpRecognizer3', 'SPRULE',
    'DISPID_SPRulesCount', 'DISPID_SLPSymbolic',
    'SVEStartInputStream', 'SPPS_Function',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SGRSTWeight',
    'DISPID_SLWLangId', 'DISPID_SVEStreamStart', 'SPVPRIORITY',
    'DISPID_SRCBookmark', 'SPPS_LMA', 'SDTAlternates', 'SBONone',
    'SITooSlow', 'ISpNotifySource', 'ISpeechRecoResultDispatch',
    'SVSFVoiceMask', 'SPWORDPRONOUNCEABLE', 'SPRST_ACTIVE_ALWAYS',
    'SPVOICESTATUS', 'SPVPRI_ALERT', 'SPPS_RESERVED2',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE5',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SABIBufferSize',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRCEBookmark',
    'IInternetSecurityManager', 'DISPID_SGRSTPropertyValue',
    'SPCATEGORYTYPE', 'SpeechTokenShellFolder',
    'DISPID_SLWPronunciations', 'SpeechAudioVolume',
    'DISPID_SDKDeleteValue', 'SLODynamic', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPEsItem', 'SPGRAMMARWORDTYPE', 'SVP_6',
    'DISPID_SRGCmdLoadFromObject', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPIDSPTSI',
    'DISPID_SRCSetAdaptationData', 'SPAR_High',
    'DISPID_SRCEInterference', 'SVP_4', 'SPXMLRESULTOPTIONS',
    'SpSharedRecoContext', 'SVP_3', 'SRCS_Disabled', 'SDTProperty',
    'DISPID_SPEDisplayText', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRSTransitions', 'SFTInput', 'SPFILEMODE',
    'SPEI_SOUND_START', 'DISPID_SPEAudioStreamOffset', 'SITooQuiet',
    'SPPS_Modifier', 'SPRECORESULTTIMES', 'DISPID_SpeechRecoResult',
    'SP_VISEME_11', 'DISPID_SOTDisplayUI', 'DISPID_SRSClsidEngine',
    'SAFT16kHz16BitMono', 'SP_VISEME_17', 'SRATopLevel',
    'SPDKL_LocalMachine', 'SAFT8kHz16BitMono', 'eWORDTYPE_ADDED',
    'SGSEnabled', 'DISPID_SVEVoiceChange',
    'DISPID_SPAStartElementInResult', 'ISpAudio', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechVoiceStatus', 'SPSVerb',
    'DISPID_SpeechRecoContextEvents', 'SGRSTTEpsilon',
    'SPPS_NotOverriden', 'DISPID_SRGRecoContext', 'SAFT12kHz8BitMono',
    'SpeechBookmarkOptions', 'SpPhoneConverter',
    'ISpeechPhraseAlternates', '_ISpeechVoiceEvents', 'SVP_18',
    'DISPID_SDKGetlongValue', 'SPEI_MIN_TTS',
    'DISPID_SVSyncronousSpeakTimeout', 'SP_VISEME_18', 'SVP_21',
    'ISpeechRecoContext', 'DISPID_SRCERecognizerStateChange',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVSFIsXML',
    'DISPID_SVEventInterests', 'SWPKnownWordPronounceable',
    'DISPID_SVVolume', 'SRAInterpreter', 'SAFTGSM610_44kHzMono',
    'DISPID_SRCEEnginePrivate', 'SpPhraseInfoBuilder',
    'SAFT8kHz16BitStereo', 'SPEI_RECO_OTHER_CONTEXT', 'SpMMAudioIn',
    'SPEVENTENUM', 'SPFM_OPEN_READONLY', 'DISPID_SPRuleName',
    'SAFTADPCM_44kHzStereo', 'SPPHRASEPROPERTY', 'SVP_2',
    'SECNormalConfidence', 'SRERecognition', 'SECFEmulateResult',
    'SAFT16kHz8BitMono', 'DISPID_SVSInputWordPosition',
    'SDA_Two_Trailing_Spaces', 'SPBOOKMARKOPTIONS',
    'DISPID_SRCRecognizer', 'SpeechCategoryAudioOut', 'ISpMMSysAudio',
    'DISPID_SPPs_NewEnum', 'DISPIDSPTSI_ActiveOffset',
    'SAFT24kHz8BitMono', 'SVSFPersistXML', 'SAFT48kHz16BitStereo',
    'ISpeechLexicon', 'DISPID_SPEs_NewEnum', 'SpeechLoadOption',
    'SVPNormal', 'SASRun', 'DISPID_SVGetProfiles', 'DISPID_SASState',
    'SREHypothesis', 'SpeechCategoryRecognizers', 'SP_VISEME_13',
    'SP_VISEME_19', 'SRTReSent', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPISaveToMemory', 'SpeechUserTraining',
    'STSF_LocalAppData', 'DISPID_SAFType', 'SPEI_INTERFERENCE',
    'SPDKL_DefaultLocation', 'DISPID_SRRGetXMLResult',
    'DISPID_SVEEnginePrivate', 'SPWORDPRONUNCIATIONLIST',
    'SAFT44kHz16BitStereo', 'Speech_Max_Word_Length',
    'SGRSTTWildcard', 'SPSSuppressWord', 'SPEI_UNDEFINED',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechPhraseInfoBuilder', 'SPEI_PHONEME', 'DISPID_SOTId',
    'DISPID_SVEBookmark', 'SpeechRecognitionType', 'ISpRecoResult',
    'SRCS_Enabled', 'DISPID_SBSRead', 'DISPID_SGRId', 'SWTDeleted',
    'ISpVoice', 'SVF_Stressed', 'SVESentenceBoundary',
    'SpCompressedLexicon', 'DISPID_SRDisplayUI', 'DISPIDSPRG',
    'SPEI_RESERVED2', 'ISpObjectWithToken', 'SPPROPERTYINFO',
    'DISPID_SRIsShared', 'SVP_1', 'ISpeechLexiconPronunciation',
    'SAFT16kHz16BitStereo', 'DISPID_SDKOpenKey',
    'SpNullPhoneConverter', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRCESoundEnd', 'DISPID_SRRRecoContext', 'SRESoundEnd',
    'DISPID_SOTCId', 'SPWAVEFORMATTYPE', 'SVEWordBoundary',
    'SPAS_CLOSED', 'SpeechCategoryPhoneConverters', 'SPWORD',
    'SpMMAudioOut', 'STCInprocHandler', 'DISPID_SGRsAdd',
    'DISPID_SRGetFormat', 'SVSFIsNotXML', 'SVSFPurgeBeforeSpeak',
    'SRAExport', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVSInputWordLength', 'SPPS_Noun', 'DISPID_SRCEHypothesis',
    'ISpShortcut', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechPhoneConverter', 'SPLO_DYNAMIC', 'DISPID_SVEPhoneme',
    'SpeechCategoryAudioIn', 'SAFTCCITT_ALaw_22kHzMono',
    'SVSFNLPMask', 'SPGS_ENABLED', 'DISPID_SLRemovePronunciation',
    'ISpStreamFormat', 'DISPID_SOTCDefault', 'SpeechAudioState',
    'DISPID_SpeechRecoResultTimes', 'SPGRAMMARSTATE',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRSNumberOfActiveRules', 'SGRSTTDictation', 'SRAImport',
    'DISPID_SASNonBlockingIO', 'SPSInterjection',
    'DISPID_SpeechRecognizer', 'DISPID_SPRText', 'DISPID_SRCVoice',
    'eLEXTYPE_PRIVATE17', 'DISPID_SADefaultFormat',
    'DISPID_SGRAddState', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTCGetDataKey', 'SAFTADPCM_11kHzMono',
    'DISPID_SLPsCount', 'DISPID_SLPPhoneIds',
    'DISPID_SABIMinNotification', 'SVPAlert', 'SPPS_Interjection',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPRuleConfidence', 'SVP_20', 'SAFTADPCM_8kHzMono',
    'SDKLCurrentUser', 'SVP_12', 'SVP_7',
    'SSSPTRelativeToCurrentPosition', 'ISpeechObjectTokenCategory',
    'DISPID_SLAddPronunciation', 'DISPID_SOTSetId', 'SGLexical',
    'SpLexicon', 'STSF_FlagCreate', 'ISpeechRecognizer',
    'ISpPhoneticAlphabetSelection', 'ISpeechAudio', 'SP_VISEME_20',
    'SVP_0', 'DISPID_SRCEPropertyNumberChange',
    'SPINTERFERENCE_TOOSLOW', 'SPRECOCONTEXTSTATUS', 'SDTReplacement',
    'DISPID_SRCESoundStart', 'SpObjectToken', 'ISpeechBaseStream',
    'SPEI_HYPOTHESIS', 'STCLocalServer',
    'ISpeechGrammarRuleStateTransition', 'SAFT11kHz16BitMono',
    'DISPID_SAStatus', 'SAFTNonStandardFormat', 'ISpeechPhraseInfo',
    'SINoSignal', 'SPXRO_SML', 'SP_VISEME_1', 'DISPID_SRRAlternates',
    'DISPID_SWFEFormatTag', 'DISPID_SpeechPhraseAlternates',
    'SpeechPartOfSpeech', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechPhraseProperties', 'IEnumString',
    'DISPID_SRCEFalseRecognition', 'SP_VISEME_12', 'DISPID_SVStatus',
    'DISPID_SMSSetData', 'SPEI_SENTENCE_BOUNDARY', 'ISpeechDataKey',
    'DISPID_SRGId', 'SPSEMANTICERRORINFO', 'SPPS_Noncontent',
    'DISPID_SRRPhraseInfo', 'Speech_StreamPos_RealTime',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPRNumberOfElements',
    'SECFIgnoreKanaType', 'SRSEDone', 'SP_VISEME_4',
    'DISPID_SPIAudioStreamPosition', 'SpeechAudioProperties',
    'SWPUnknownWordPronounceable', 'DISPID_SABufferInfo',
    'SREAudioLevel', 'SPBO_AHEAD', 'DISPID_SPARecoResult',
    'SGDisplay', 'SpeechVisemeFeature', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE12', 'ISequentialStream',
    'SPVPRI_OVER', 'DISPID_SRSAudioStatus', 'DISPID_SRAudioInput',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechPhraseBuilder', 'SPRS_INACTIVE',
    'SpObjectTokenCategory', 'DISPID_SOTDataKey', 'SREInterference',
    'eLEXTYPE_RESERVED6', 'SVP_5', 'DISPID_SGRsDynamic',
    'SPCS_ENABLED', 'SPAS_PAUSE', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCERecognitionForOtherContext', 'SRADynamic',
    'ISpRecoContext2', 'SAFT24kHz16BitStereo', 'DISPID_SRGCommit',
    '__MIDL_IWinTypes_0009', 'SpeechSpecialTransitionType',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPAs_NewEnum',
    'SAFT12kHz16BitStereo', 'SPPS_RESERVED1', 'SAFT8kHz8BitMono',
    'SpeechEngineProperties', 'SRERequestUI', 'SGDSActive',
    'DISPID_SPIElements', 'DISPID_SPRs_NewEnum',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpeechRecoResult2', 'SSTTDictation',
    'SPAR_Low', 'DISPID_SLWsItem', 'ISpSerializeState',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRGDictationSetState', 'SLTUser',
    'IInternetSecurityMgrSite', 'DISPID_SLWsCount',
    'DISPID_SWFEBitsPerSample', 'SAFT11kHz8BitMono',
    'DISPID_SpeechLexicon', 'DISPID_SLWWord', 'SpeechTokenKeyUI',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechPhraseElements',
    'DISPID_SRRSpeakAudio', 'SpeechWordPronounceable',
    'DISPID_SMSGetData', 'SPSModifier', 'SPEI_ADAPTATION',
    'DISPID_SVEStreamEnd', 'ISpeechPhraseProperties', 'SP_VISEME_9',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPRules_NewEnum',
    'SpeechAudioFormatGUIDText', 'SpFileStream',
    'SAFT48kHz8BitStereo', 'SVSFParseSapi',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SOTGetDescription',
    'SPWT_PRONUNCIATION', 'DISPID_SPEAudioSizeBytes',
    'SPSHORTCUTPAIRLIST', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRRAudio',
    'SpeechTokenKeyAttributes', 'DISPID_SRCEEndStream',
    'SpeechPropertyResourceUsage', 'SPEI_WORD_BOUNDARY', 'SGRSTTWord',
    'SECFDefault', 'SpeechCategoryAppLexicons',
    'ISpeechPhraseProperty', 'SAFT22kHz8BitMono', 'SPAUDIOSTATE',
    'SDKLDefaultLocation', 'eLEXTYPE_RESERVED8', 'SVP_17',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SWFESamplesPerSec',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPCPhoneToId', 'SP_VISEME_2',
    'DISPID_SVGetAudioInputs', 'ISpProperties', 'DISPID_SVPriority',
    'SPEI_VISEME', 'SRTAutopause', 'DISPID_SPPEngineConfidence',
    'SITooFast', 'DISPID_SVSpeakStream', 'SPFM_CREATE',
    'SGDSActiveWithAutoPause', 'ISpPhoneConverter',
    'SVSFNLPSpeakPunc', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SOTIsUISupported', 'SPSNoun', 'ISpeechFileStream',
    'DISPID_SGRInitialState', 'SP_VISEME_8', 'SSFMOpenForRead',
    'SPCT_DICTATION', 'SPEI_RESERVED1', 'SpeechGrammarTagDictation',
    'SPPHRASEELEMENT', 'ISpeechPhraseReplacements',
    'DISPID_SRGSetWordSequenceData', 'ISpeechPhraseElements',
    'SVSFUnusedFlags', 'SP_VISEME_7', 'SpeechTokenValueCLSID',
    'SpeechWordType', 'DISPID_SGRSTType', 'SpeechVoiceSpeakFlags',
    'DISPID_SOTsItem', 'SGRSTTTextBuffer', 'SPLO_STATIC',
    'ISpeechObjectToken', 'DISPID_SGRSAddWordTransition',
    'SpeechRetainedAudioOptions', 'SAFTADPCM_11kHzStereo',
    'ISpDataKey', 'SVSFlagsAsync', 'DISPID_SAVolume',
    'DISPID_SRGCmdLoadFromResource', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPINTERFERENCE_NOSIGNAL', 'SRTSMLTimeout', 'SPCT_SUB_DICTATION',
    'ISpeechRecoGrammar', 'DISPID_SRCCreateGrammar', 'DISPID_SBSSeek',
    'SVEVoiceChange', 'SPAUDIOSTATUS', 'SVF_None',
    'SPRECOGNIZERSTATUS', 'ISpeechRecoResultTimes',
    'DISPID_SPIGrammarId', 'eLEXTYPE_USER_SHORTCUT',
    'SPINTERFERENCE_TOOLOUD', 'SLOStatic', 'SpeechRuleState',
    'SSTTWildcard', 'DISPID_SPAsCount', 'STCRemoteServer',
    'SAFT32kHz8BitMono', 'SPAUDIOBUFFERINFO',
    'SAFTCCITT_uLaw_8kHzMono', 'eLEXTYPE_RESERVED7',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPERetainedSizeBytes',
    'SPPS_RESERVED3', 'DISPID_SRRTOffsetFromStart', 'SVP_13',
    'SPEI_SR_AUDIO_LEVEL', 'SPEVENTSOURCEINFO', 'SVSFParseAutodetect',
    'SRADefaultToActive', 'SpeechRecognizerState', 'SECFIgnoreWidth',
    'STCInprocServer', 'DISPID_SOTCategory', 'DISPID_SVRate',
    'SPCT_SUB_COMMAND', 'DISPID_SRGState', 'SASStop', 'SPSHT_EMAIL',
    'ISpRecoGrammar', 'SPRST_INACTIVE', 'DISPID_SOTs_NewEnum',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SLPs_NewEnum',
    'SPGS_EXCLUSIVE', 'DISPID_SpeechAudioStatus', 'DISPID_SRRTimes',
    'DISPID_SGRsItem', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechDisplayAttributes', 'DISPID_SRCEAdaptation',
    'ISpNotifyTranslator', 'DISPID_SBSFormat', 'DISPID_SRState',
    'SpeechInterference', 'DISPID_SRRTTickCount',
    'eLEXTYPE_PRIVATE16', 'SpeechEngineConfidence', 'SPINTERFERENCE',
    'SPAO_NONE', 'ISpeechRecoResult', 'SPEI_VOICE_CHANGE',
    'SPPS_Verb', 'SpeechVoiceEvents', 'eLEXTYPE_PRIVATE4',
    'DISPID_SDKSetBinaryValue', 'SPAS_STOP', 'SRERecoOtherContext',
    'eLEXTYPE_PRIVATE8', 'SpeechGrammarTagWildcard',
    'DISPID_SPANumberOfElementsInResult', 'SPDATAKEYLOCATION',
    'SSFMOpenReadWrite', 'SpeechAudioFormatGUIDWave',
    'SpeechTokenKeyFiles', 'DISPID_SRRTStreamTime',
    'DISPID_SASCurrentDevicePosition', 'SPWORDLIST', 'SPLOADOPTIONS',
    'SVEEndInputStream', 'DISPID_SPIReplacements', 'SPSNotOverriden',
    'SREAllEvents', 'DISPID_SVEWord', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRIsUISupported', 'SpUnCompressedLexicon', 'SPSUnknown',
    'DISPID_SRGReset', 'DISPID_SGRsFindRule', 'DISPID_SVPause',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVSkip',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCEAudioLevel', 'ISpeechPhraseReplacement',
    'SpeechLexiconType', 'SPPS_RESERVED4', 'SPFM_NUM_MODES',
    'SREPhraseStart', 'DISPID_SPRsCount',
    'DISPID_SOTGetStorageFileName', 'tagSPPROPERTYINFO',
    'SPSHORTCUTPAIR',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT48kHz8BitMono', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPPValue', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SVResume', 'SpeechRegistryLocalMachineRoot',
    'SPBINARYGRAMMAR', 'SRSInactiveWithPurge', 'SGSExclusive',
    'DISPID_SRRGetXMLErrorInfo', 'SRTEmulated',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTPropertyName',
    'ISpRecoCategory', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPSEMANTICFORMAT', 'SpeechRecoEvents', 'ISpeechAudioFormat',
    'SPRULESTATE', 'SPBO_NONE', 'eLEXTYPE_RESERVED10',
    'SAFTNoAssignedFormat', 'DISPID_SRGDictationLoad', 'ISpPhrase',
    'ISpPhoneticAlphabetConverter', 'SPEI_SR_PRIVATE', 'ISpLexicon',
    'DISPID_SLPPartOfSpeech', 'SAFTCCITT_uLaw_44kHzMono',
    'SREStreamEnd', 'SpeechCategoryVoices', 'SAFTADPCM_44kHzMono',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPRuleFirstElement',
    'DISPID_SVAlertBoundary', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVP_10', 'DISPID_SRSetPropertyNumber', 'SDKLLocalMachine',
    'DISPID_SPEPronunciation', 'ISpeechObjectTokens',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechVoiceEvent',
    'SP_VISEME_5', 'SpeechGrammarState', 'DISPID_SVSPhonemeId',
    'SPSFunction', 'SDTAudio', 'DISPID_SRGetPropertyNumber',
    'SPEI_SOUND_END', 'SpeechDictationTopicSpelling',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPRuleId',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRSAddRuleTransition',
    'SAFT32kHz8BitStereo', 'SREPropertyNumChange',
    'SAFT12kHz8BitStereo', 'DISPID_SGRSTNextState', 'SPEI_MAX_TTS',
    'SPSHT_NotOverriden', 'SPSHT_Unknown', 'SpNotifyTranslator',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SDKGetBinaryValue',
    'SPEI_REQUEST_UI', 'DISPID_SPAPhraseInfo', 'SSFMCreate',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE15',
    'SAFT16kHz8BitStereo', 'SPSTREAMFORMATTYPE', 'SPSHORTCUTTYPE',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SREAdaptation',
    'SAFT22kHz16BitMono', 'SFTSREngine', 'DISPID_SGRSTsItem',
    'SWTAdded', 'SGDSInactive', 'SVEBookmark', 'DISPID_SGRs_NewEnum',
    'SPWORDTYPE', 'DISPID_SRCRetainedAudio', 'DISPID_SGRSRule',
    'ISpeechWaveFormatEx', 'SPPS_Unknown', 'SPXRO_Alternates_SML',
    'SVSFParseMask', 'SREPrivate', 'ISpeechVoiceStatus',
    'DISPID_SPPConfidence', 'DISPID_SOTRemove', 'SPVISEMES',
    'STSF_AppData', 'DISPID_SRCERecognition', 'ISpeechGrammarRule',
    'SP_VISEME_6', 'SPBO_TIME_UNITS', 'eLEXTYPE_RESERVED4',
    'DISPID_SpeechGrammarRule', 'SGDSActiveUserDelimited',
    'STSF_CommonAppData', 'DISPID_SPCLangId', 'DISPID_SLWType',
    'eLEXTYPE_VENDORLEXICON', 'SVP_15', 'SPAR_Unknown',
    'SpeechVoicePriority', 'SpeechMicTraining', 'SPEI_PHRASE_START',
    'DISPID_SVSInputSentenceLength', 'DISPID_SVEViseme', 'SPEVENT',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_RESERVED9',
    'eLEXTYPE_PRIVATE7', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSLastBookmark', 'SP_VISEME_14', 'DISPID_SRRecognizer',
    'DISPID_SRRSetTextFeedback', 'ISpObjectToken',
    'DISPID_SGRAttributes', 'SpeechRecoProfileProperties',
    'DISPID_SpeechMemoryStream', 'DISPID_SVSVisemeId', 'SP_VISEME_15',
    'SAFTADPCM_22kHzMono', 'SASClosed', 'SpPhoneticAlphabetConverter',
    'SDTAll', 'DISPID_SAFGuid', 'SpeechDataKeyLocation',
    'DISPID_SpeechVoice', 'DISPID_SVSRunningState',
    'DISPID_SGRSTsCount', 'SpInprocRecognizer', 'DISPID_SVGetVoices',
    'DISPID_SRStatus', 'DISPID_SPPsCount', 'ISpXMLRecoResult',
    'SpeechVoiceSkipTypeSentence', 'SPAR_Medium',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechPhraseProperty', 'DISPID_SMSALineId',
    'SPEI_START_SR_STREAM', 'ISpStream', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechAudioFormat', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechPhraseRules', 'DISPID_SPIAudioSizeBytes',
    'SpeechAddRemoveWord', 'SPINTERFERENCE_NONE',
    'SPEI_END_INPUT_STREAM', 'SECFNoSpecialChars',
    'SECHighConfidence', 'SAFT22kHz16BitStereo',
    'SpeechRegistryUserRoot', 'DISPID_SGRSTRule', 'SVSFDefault',
    'DISPID_SPEDisplayAttributes', '_RemotableHandle',
    'DISPID_SPIGetText', 'eLEXTYPE_USER', 'SRTExtendableParse',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SPIProperties',
    'DISPID_SDKEnumKeys', 'SPLEXICONTYPE', 'ISpeechAudioStatus',
    'SAFT32kHz16BitStereo', 'ISpeechMemoryStream',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SGRSAddSpecialTransition', 'SPRST_NUM_STATES',
    'Speech_Default_Weight', 'UINT_PTR', 'SRAONone', 'LONG_PTR',
    'DISPID_SPILanguageId', 'SPPS_SuppressWord', 'DISPID_SGRsCount',
    'SAFT32kHz16BitMono', 'SPPHRASERULE', 'SPSMF_UPS',
    'DISPID_SRRSaveToMemory', 'SpeechPropertyAdaptationOn',
    'DISPID_SABIEventBias', 'DISPID_SWFEBlockAlign', 'SPCT_SLEEP',
    'DISPID_SOTGetAttribute', 'tagSTATSTG', 'SPWF_INPUT',
    'SAFT11kHz16BitStereo', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVDisplayUI', 'DISPID_SpeechPhraseInfo', 'SINoise',
    'SAFTDefault', 'DISPID_SRGIsPronounceable', 'SAFTGSM610_8kHzMono',
    'SP_VISEME_16', 'SDTDisplayText', 'SpeechRecoContextState',
    'SLTApp', 'SPCT_COMMAND', 'DISPID_SLWs_NewEnum',
    'ISpeechLexiconWords', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechAllElements', 'SDA_Consume_Leading_Spaces', 'SVP_8',
    'Speech_Max_Pron_Length', 'SGPronounciation',
    'DISPID_SWFEExtraData', 'SpShortcut', 'SpAudioFormat',
    'SPEI_MAX_SR', 'SAFT11kHz8BitStereo', 'SPEI_RESERVED6',
    'DISPID_SDKSetStringValue', 'DISPID_SRCERequestUI',
    'DISPID_SPPChildren', 'SpeechDiscardType', 'IEnumSpObjectTokens',
    'SPAS_RUN', 'DISPID_SMSADeviceId', 'DISPID_SPIStartTime',
    'SpeechVisemeType', 'DISPID_SVIsUISupported',
    'DISPID_SPEActualConfidence', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpTextSelectionInformation', 'SAFT48kHz16BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPARTOFSPEECH',
    'SAFTGSM610_22kHzMono', 'DISPID_SRCPause',
    'SpeechEmulationCompareFlags', 'SAFTGSM610_11kHzMono',
    'ISpObjectTokenCategory', 'DISPID_SLPLangId', 'SDTPronunciation',
    'SPADAPTATIONRELEVANCE', 'SVP_9', 'SpSharedRecognizer',
    'DISPID_SAEventHandle', 'ISpeechCustomStream', 'DISPID_SGRClear',
    'DISPID_SPPName', 'SECLowConfidence', 'ISpEventSource',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE10', '_SPAUDIOSTATE',
    'DISPID_SGRSTText', 'SINone', 'SpStream',
    'DISPID_SpeechGrammarRules', 'DISPID_SpeechRecoResult2',
    'DISPID_SPRsItem', 'ISpResourceManager', 'SVEPrivate',
    'SRESoundStart', 'DISPID_SRCState', 'SRSEIsSpeaking',
    'DISPID_SPPsItem', 'SAFT44kHz8BitMono', 'DISPID_SFSOpen',
    'ISpNotifySink', 'SRARoot', 'SGSDisabled',
    'ISpeechGrammarRuleStateTransitions', 'SpeechStreamFileMode',
    'SPFM_CREATE_ALWAYS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWT_DISPLAY', 'SSFMCreateForWrite',
    'DISPID_SLGetGenerationChange', 'DISPID_SOTCreateInstance',
    'SpWaveFormatEx', 'SpeechAudioFormatType', 'eWORDTYPE_DELETED',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SOTRemoveStorageFileName', 'SVPOver', 'SVP_16',
    'SPRECOSTATE', 'SVP_11', 'DISPID_SLPsItem', 'SPEI_RESERVED3',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SDKGetStringValue',
    'SPTEXTSELECTIONINFO', 'ISpEventSink', 'DISPID_SPRuleParent',
    'DISPID_SCSBaseStream', 'DISPID_SRCEStartStream',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SDKCreateKey',
    'DISPID_SRCEventInterests', 'SVEAudioLevel', 'DISPID_SGRsCommit',
    'SPCONTEXTSTATE', 'DISPID_SPCIdToPhone', 'DISPID_SPPId',
    'SPEI_START_INPUT_STREAM', 'SVSFIsFilename',
    'SpeechRuleAttributes', 'SpeechTokenIdUserLexicon',
    'ISpGrammarBuilder', 'DISPID_SFSClose', 'SRTStandard',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SLGetWords', 'ISpeechGrammarRuleState',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechPhraseAlternate',
    'SPEI_FALSE_RECOGNITION', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPRST_ACTIVE', 'SSSPTRelativeToEnd', 'Speech_StreamPos_Asap',
    'SDTLexicalForm', 'SPSERIALIZEDPHRASE', 'DISPID_SVVoice',
    'eLEXTYPE_APP', 'SAFT22kHz8BitStereo', 'SPAUDIOOPTIONS',
    'DISPID_SGRAddResource', 'ISpeechRecognizerStatus',
    'DISPID_SVSLastStreamNumberQueued', 'SITooLoud',
    'DISPID_SVSLastBookmarkId', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechResourceLoader', 'DISPID_SASFreeBufferSpace',
    'DISPID_SVAudioOutputStream', 'SVP_19', 'DISPID_SRGRules',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechGrammarTagUnlimitedDictation',
    'SVEViseme', 'DISPID_SPEsCount', 'SPEI_RECO_STATE_CHANGE',
    'SSSPTRelativeToStart', 'SVEAllEvents', 'tagSPTEXTSELECTIONINFO',
    'SpeechFormatType', 'SRSActiveAlways', 'DISPID_SLPType',
    'SVF_Emphasis', 'SpCustomStream', 'ISpeechPhraseRule',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPRDisplayAttributes',
    'SPWT_LEXICAL', 'DISPID_SVESentenceBoundary',
    'SAFT44kHz16BitMono', 'DISPID_SLGetPronunciations',
    'SPEI_TTS_PRIVATE', 'DISPID_SpeechObjectToken',
    'SREPropertyStringChange', 'SREFalseRecognition',
    'SDA_No_Trailing_Space', 'DISPID_SPIEngineId',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRCRequestedUIType', 'SPGS_DISABLED',
    'DISPID_SPEEngineConfidence', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SBSWrite', 'SP_VISEME_3',
    'SpeechPropertyResponseSpeed', 'DISPID_SMSAMMHandle',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRGetRecognizers',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPPFirstElement', 'SpeechGrammarWordType',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechRecoContext',
    'DISPID_SPRulesItem', 'SpInProcRecoContext',
    'DISPID_SVEAudioLevel', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpRecognizer', 'DISPID_SpeechPhraseRule', 'DISPID_SVSpeak',
    'DISPID_SPERetainedStreamOffset', 'ISpRecoContext',
    'DISPID_SRCVoicePurgeEvent', 'SpMemoryStream',
    'SpeechStreamSeekPositionType', 'ISpPhraseAlt',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SGLexicalNoSpecialChars', 'SPVPRI_NORMAL', 'eLEXTYPE_PRIVATE6',
    'ISpeechMMSysAudio', 'DISPID_SPRuleChildren', 'SDTRule',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRProfile',
    'SPEI_END_SR_STREAM', 'IStream', 'SpVoice',
    'DISPID_SPRuleEngineConfidence', 'SPCS_DISABLED',
    'DISPID_SpeechLexiconProns', 'SP_VISEME_21',
    'SAFTExtendedAudioFormat', 'DISPID_SRCRetainedAudioFormat',
    'ISpeechLexiconWord', 'SpStreamFormatConverter',
    'DISPID_SpeechPhraseReplacement', 'SPEI_TTS_BOOKMARK',
    'SWPUnknownWordUnpronounceable', 'ISpRecognizer2',
    'DISPID_SpeechObjectTokens', 'DISPID_SWFEChannels', 'SREBookmark',
    'SpeechTokenContext', 'SAFTCCITT_uLaw_11kHzMono',
    'SSTTTextBuffer', 'SPEI_RECOGNITION',
    'DISPID_SRSetPropertyString', 'DISPID_SRCEPhraseStart',
    'ISpeechVoice', 'SPPHRASE', 'DISPID_SASetState',
    'ISpStreamFormatConverter', 'SDA_One_Trailing_Space',
    'SPWF_SRENGINE', 'eLEXTYPE_MORPHOLOGY', 'SREStreamStart',
    'SPFM_OPEN_READWRITE', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRsCommitAndSave', 'ISpeechPhraseElement',
    'DISPID_SGRSTs_NewEnum', 'SGRSTTRule', 'DISPID_SVWaitUntilDone',
    'SPINTERFERENCE_NOISE', 'DISPID_SPELexicalForm',
    'DISPID_SVSpeakCompleteEvent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRGDictationUnload',
    'DISPID_SLGenerationId', 'SDKLCurrentConfig',
    'DISPID_SPRuleNumberOfElements', 'SPEI_TTS_AUDIO_LEVEL',
    'SBOPause', 'DISPID_SRSSupportedLanguages'
]

_check_version('1.2.0', 1651900785.163668)
